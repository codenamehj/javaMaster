			...
			<div class="col-md-6">
				...
				<div class="d-flex">
					<input class="form-control text-center me-3" id="inputQuantity"
						type="num" value="${vo.likeIt }" style="max-width: 3rem" />
...
<section class="py-5 bg-light">
	<div class="container px-4 px-lg-5 mt-5">
		...
		<div
			...
			<c:forEach begin="1" end="4" var="list" items="${productList }">
				<div class="col mb-5">
					<div class="card h-100">
						...
						<div class="card-body p-4">
							<div class="text-center">
								<!-- Product name-->
								<h5 class="fw-bolder">
									<a href="getProduct.do?pno=${list.productCode }">${list.productName }</a>
								</h5>
								<!-- Product reviews-->
								<div
