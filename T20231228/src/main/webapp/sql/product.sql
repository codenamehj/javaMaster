...
insert into product values('P2023-01', '과테말라 안티구아', '과테말라 안티구아 원두입니다.', 5000, 4500, 5, '과테말라.jpg');
insert into product values('P2023-02', '니카라구아 아라비카', '니카라구아 아라비카 원두입니다.', 5500, 4500, 4, '니카라구아 더치.jpg');
insert into product values('P2023-03', '브라질산토스', '브라질산토스 원두입니다.', 6000, 5000, 3, '브라질산토스.jpg');
